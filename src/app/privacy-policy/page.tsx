    ...
    <>
      <div className="max-w-4xl mx-auto py-10 px-5">
        ...
        <p className="text-gray-700 mb-4">
          ...
          private limited (“us”, “we”, or “our”) operates leadlly.in
          (hereinafter referred to as “Service”). Our Privacy Policy governs
          your visit to leadlly.in, and explains how we collect, safeguard and
        ...
        <p className="text-gray-700 mb-4">
          ...
          individual who can be identified from that data (or from those and
          other information either in our possession or likely to come into our
          possession).
        </p>
        <p className="text-gray-700 mb-4">
          <b className="font-bold">USAGE DATA</b> is data collected
        ...
        <p className="text-gray-700 mb-4">
          ...
          Service. The User corresponds to the Data Subject, who is the subject
          of Personal Data.
        </p>
        ...
        <p className="text-gray-700 mb-4">
          Leadlly Edusolutions Private Limited uses the collected data for
          various purposes:
        </p>
        ...
        <p className="text-gray-700 mb-4">
          ...
          outside India and choose to provide information to us, please note
          that we transfer the data, including Personal Data, to India and
          ...
          transfer. Leadlly Edusolutions Private Limited will take all the steps
        ...
        <p className="text-gray-700 mb-4">
          ...
          the Personal Data that we collect and process about you. The measures
        ...
        <p className="text-gray-700 mb-4">
          ...
          Personal Data, we will provide you with appropriate notice in
        ...
        <p className="text-gray-700 mb-4">
          ...
          purposes of this Privacy Policy. This means that we are responsible
          for deciding how we hold and use Personal Data about you.
        </p>
        ...
        <p className="text-gray-700 mb-4">
          You have the right to request the deletion of your personal data held
          by Leadlly Edusolutions. To initiate the deletion process, please send
          an email to{" "}
          <a
