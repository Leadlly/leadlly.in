    ...
    <>
      <div className="max-w-4xl mx-auto py-10 px-5">
        ...
        <p className="text-gray-700 mb-4 ">
          Welcome to Leadlly edusolutions private limited (“Company”, “we”,
          “our”, “us”)!
        </p>
        <p className="text-gray-700 mb-4">
          These Terms of Service (“Terms”, “Terms of Service”) govern your use
          of our website located at leadlly.in (together or individually
          “Service”) operated by Leadlly edusolutions private limited.
        </p>
        <p className="text-gray-700 mb-4">
        ...
        <ul className="list-disc list-inside mb-4">
          ...
          <li>
            ...
            limitation any right of privacy or intellectual property right.
          </li>
        ...
        <ul className="list-disc list-inside mb-4">
          ...
          <li>
            To impersonate or attempt to impersonate Leadlly, a Leadlly
        ...
        <p className="text-gray-700 mb-4">
          ...
          use of the Service and supersede and replace any prior agreements we
