  ...
  return (
    <div className="max-w-4xl mx-auto py-10 px-5">
      ...
      <p className="text-gray-700 mb-4 ">
        Welcome to Leadlly edusolutions private limited (“Company”, “we”, “our”,
        “us”)!
      </p>
      <p className="text-gray-700 mb-4">
        These Terms of Service (“Terms”, “Terms of Service”) govern your use of
        our website located at leadlly.in (together or individually “Service”)
      ...
      <p className="text-gray-700 mb-4">
        ...
        support@leadlly.in so we can try to find a solution. These Terms apply
        to all visitors, users and others who wish to access or use Service.
      </p>

      <h2 className="text-2xl font-semibold mt-6 mb-2">2. Communications</h2>
      <p className="text-gray-700 mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">4. Availability</h2>
      <p className="text-gray-700 mb-4">
        Our Service is made available solely for your personal use. You agree
        not to use our Service for any commercial purposes without our prior
        written consent.
      </p>
      <p className="text-gray-700 mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">5. User Accounts</h2>
      <p className="text-gray-700 mb-4">
      ...
      <p className="text-gray-700 mb-4">
        ...
        and password and for restricting access to your computer and account.
      </p>
      <p className="text-gray-700 mb-4">
        You agree to accept responsibility for all activities or actions that
        occur under your account and password.
      </p>

      <h2 className="text-2xl font-semibold mt-6 mb-2">6. Content</h2>
      <p className="text-gray-700 mb-4">
      ...
      <p className="text-gray-700 mb-4">
        ...
        and will remain the exclusive property of Leadlly edusolutions private
      ...
      <p className="text-gray-700 mb-4">
        You agree to defend, indemnify and hold harmless Leadlly edusolutions
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li>
          ...
          any right of privacy or intellectual property right.
        </li>
      ...
      <p className="text-gray-700 mb-4">
        In no event shall Leadlly edusolutions private limited, nor its
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">11. Disclaimer</h2>
      <p className="text-gray-700 mb-4">
        Your use of the Service is at your own risk. The Service is provided on
      ...
      <ul className="list-disc list-inside mb-4">
        <li>By email: support@leadlly.in</li>
        <li>By visiting this page on our website: leadlly.in/contact</li>
      </ul>
      ...
      <p className="text-gray-700 mb-4">
        By using the Service, you acknowledge that you have read these Terms and
        agree to be bound by them.
      </p>

      <h2 className="text-2xl font-semibold mt-6 mb-2">16. User Conduct</h2>
      <p className="text-gray-700 mb-4">
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li>
          To impersonate or attempt to impersonate Leadlly, a Leadlly employee,
      ...
      <p className="text-gray-700 mb-4">
        You may provide us either directly at support@leadlly.in or via third
      ...
      <p className="text-gray-700 mb-4">
        ...
        are not owned or controlled by Leadlly.
      </p>
      <p className="text-gray-700 mb-4">
        Leadlly has no control over, and assumes no responsibility for, the
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">22. Severability</h2>
      <p className="text-gray-700 mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">24. Entire Agreement</h2>
      <p className="text-gray-700 mb-4">
        These Terms constitute the entire agreement between us regarding the use
        of the Service and supersede and replace any prior agreements we might
        have had between us regarding the Service.
      </p>

      <h2 className="text-2xl font-semibold mt-6 mb-2">25. Changes to Terms</h2>
      <p className="text-gray-700 mb-4">
        We reserve the right to modify these Terms at any time. We will notify
        you of any changes by posting the new Terms on this page.
      </p>

      <h2 className="text-2xl font-semibold mt-6 mb-2">26. Contact Us</h2>
      <p className="text-gray-700 mb-4">
        If you have any questions about these Terms, please contact us:
      </p>
      <ul className="list-disc list-inside mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">27. Acknowledgment</h2>
      <p className="text-gray-700 mb-4">
