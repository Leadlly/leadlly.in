...
export default function Footer() {
  ...
  return (
    <section className=" px-2 py-8 sm:py-12 lg:pb-1 lg:scroll-pt-24 md:px-16 w-full container ">
        ...
        <div className="md:col-span-2">
          <Link href="/">
            <Image
              ...
              width={200}
              height={70}
              className="mb-4 sm:mb-5 w-40 sm:w-48"
            />
          </Link>
          <p className="mb-4 text-gray-600 text-sm sm:text-base w-full sm:w-80">
            We are on a mission to help aspirants in managing all the studies
      ...
      <div className="my-4 pt-4 border-t-2 border-gray-300 text-center ">
        <p className="text-xs sm:text-sm text-gray-600">
          ...
          <strong>Leadlly Edusolutions Private Limited</strong> @{currentYear}
        </p>
      </div>
    </section>
  );
