    ...
    <div id="download-section" className="text-foreground py-20">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg mb-8">Experience personalized mentorship and tracking on the go</p>
          ...
          >
            <motion.a 
              ...
              className={cn(
                ...
                "bg-[#E8DAEE] text-primary border-2 border-[#D0B5F9] hover:bg-[#D0B5F9] hover:text-white"
              )}
              target="_blank"
            ...
            <motion.a 
              ...
              className={cn(
                "flex-1 inline-flex items-center justify-center px-6 py-4 font-semibold rounded-full transition duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
                "bg-[#FEFBFF] text-primary border-2 border-black/30 hover:bg-[#F4E8FF] hover:border-primary"
              )}
              target="_blank"
              rel="noopener noreferrer"
              whileHover={{ scale: 1.05, boxShadow: "0 10px 20px rgba(0, 0, 0, 0.1)" }}
